...
object Responses {
  ...
  case class IncomingMessage(chatId: String, text: String, author: String) extends MessagingResponseDTO
  case class SubscribedToChat(chatId: String) extends MessagingResponseDTO

  case class AlreadySubscribed(chatId: String) extends MessagingResponseDTO
